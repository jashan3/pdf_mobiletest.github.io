...
// const DEFAULT_URL = "../web/sample.pdf";
...
const PDFViewerApplication = {
  ...
  open(params) {
    ...
    self.pdfViewer.spreadMode = SpreadMode.ODD;
    self.pdfViewer.scrollMode = ScrollMode.PAGE;
...
const pdfInputFile = document.getElementById('pdf-input-file');
